...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/google-cloud-logging-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-cloud-logging-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add google-cloud-logging
# for installing globally
pixi global install google-cloud-logging
```
...
It is possible to list all of the versions of `google-cloud-logging` available on your platform:
...
```
pixi search google-cloud-logging --channel conda-forge
```
